...
<div class="card text-center position-absolute top-50 start-50 translate-middle">
    ...
    <div class="card-body">
        <h5 class="card-title" style="font-size: 1.8rem"><i class="bi bi-qr-code-scan"></i>&nbsp;&nbsp;Scan Here</h5>
        <p class="card-text" style="font-size: 1rem">Wait a moment, your transaction is being processed</p>
